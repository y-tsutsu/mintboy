...
When the ROMs are present at `rom/tests/gb-test-roms`, CMake also registers the Blargg CPU instruction ROMs as optional CTest cases. Re-run CMake after cloning the ROMs so the tests are discovered:
